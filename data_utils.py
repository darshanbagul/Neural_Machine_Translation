...
def main(data_file_1, data_file_2, out_pickle_file):
    en_sentences = read_sentences(data_file_1)
    de_sentences = read_sentences(data_file_2)

    save_dataset(out_pickle_file, create_dataset(en_sentences, de_sentences))

if __name__ == '__main__':
    if len(sys.argv) == 4:
        main(sys.argv[1], sys.argv[2], sys.argv[3])
    else:
        print "usage: python data_utils.py <language1_file_path> <language2_file_path> <output_pickle_filepath>"
        sys.exit()